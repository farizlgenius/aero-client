...
export const Reports = () => {
      ...
      {/* Header Select */ }
      const headerOptions: MultiselectOption[] = [{
            value: "dateTime",
            text: "Date",
            selected: true
      }, {
      ...
      const [header, setHeader] = useState<string[]>(headerOptions.filter(opt => opt.selected).map(opt => opt.text));
      const [keys, setKeys] = useState<string[]>(headerOptions.filter(opt => opt.selected).map(opt => opt.value));

      {/* Filter Data */ }
      const [sourceOption, setSourceOption] = useState<Options[]>([]);
      ...
      return (
            <>
                  <PageBreadcrumb pageTitle="Events Report" />
                  <div className="flex flex-col gap-2">
                        ...
                        <div className="grid grid-cols-3 p-10 gap-4 rounded-xl border border-gray-200 p-6 dark:border-gray-800 border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03] " >
                              ...
                              <div className="flex flex-col">
                                    <Label>Module</Label>
                                    <div className="flex">
                                          <Select options={sourceOption} name={"Source"} className="dark:bg-dark-900" defaultValue={source} onChangeWithEvent={handleChange} />
                                    </div>
                              ...
                              <div className="flex flex-col">
                                    <Label>Device</Label>
                                    <div className="flex">
                                          <Select isString={false} options={deviceOption} name={"Device"} className="dark:bg-dark-900" defaultValue={device} onChangeWithEvent={handleChange} />
                                    </div>
                              ...
                              <div className="flex items-center justify-center gap-5 col-span-3">

                                    <Button name="generate" onClick={handleClick} className="w-1/3">Generate</Button>
                                    <Button name="clear" className="w-1/3" onClick={handleClick}>Clear</Button>
                        ...
                        <div className="space-y-6">
                              <div className="overflow-hidden rounded-xl border border-gray-200 bg-white dark:border-white/[0.05] dark:bg-white/[0.03]">
                                    <div className="max-w-full overflow-x-auto">
                                          ...
                                          {
                                                header.length > 0 && keys.length > 0 && (
                                                      <TransactionTable tableHeaders={header} tableDatas={tableDatas} tableKeys={keys} specialDisplay={[
                                                            {
                                                                  key: "dateTime",
