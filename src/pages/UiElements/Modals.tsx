        ...
        <div className="flex">
            <div className="fixed inset-0 flex items-center justify-center p-5 overflow-y-auto modal z-99998">
                ...
                <div className={isWide ? wide:notWide}>
                    ...
                    <button onClick={handleClickWithEvent} name="close" className="group absolute right-3 top-3 z-999 flex h-9.5 w-9.5 items-center justify-center rounded-full bg-gray-200 text-gray-500 transition-colors hover:bg-gray-300 hover:text-gray-500 dark:bg-gray-800 dark:hover:bg-gray-700 sm:right-6 sm:top-6 sm:h-11 sm:w-11">
                    ...
                    <div className="text-gray-800 dark:text-white/90 pt-1">
                        {body}
                    </div>
