...
export const BaseForm: React.FC<PropsWithChildren<FormProp>> = ({ tabContent }) => {
  ...
  const activeStyle = 'text-brand-500 border-brand-500  dark:text-brand-400 dark:border-brand-400'
  const inactiveStyle = 'bg-transparent text-gray-500 border-transparent hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200'
