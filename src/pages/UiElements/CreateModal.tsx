...
const CreateModal:React.FC<PropsWithChildren<CreateModalProp>> = ({handleClick}) => {
    return (
        <>
                ...
                <div className="relative w-full max-w-[600px] rounded-3xl bg-white p-6 dark:bg-gray-900 lg:p-10">
                    ...
                    <div className="text-center">
                        ...
                        <p className="text-sm leading-6 text-gray-500 dark:text-gray-400">
                            Please confirm to create components
                        </p>

                        <div className="flex items-center justify-center w-full gap-5 mt-7">
                            <button name='create-confirm' onClick={handleClick} type="button" className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-error-500 shadow-theme-xs hover:bg-error-600 sm:w-auto">
                                Confirm
                            </button>
                            <button name='create-cancel' onClick={handleClick} type="button" className="flex justify-center w-full px-4 py-3 text-sm font-medium text-white rounded-lg bg-blue-500 shadow-theme-xs hover:bg-blue-600 sm:w-auto">
                                Cancel
                            </button>
                        </div>
                    </div>
