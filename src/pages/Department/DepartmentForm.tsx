            ...
            <div className="flex flex-col gap-5 justify-center items-center p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
                <div className='flex gap-2 mb-3 w-1/2'>
                    <div className='flex-1'>
                        ...
                        <Input disabled={type == FormType.INFO} placeholder="Department Name" name="name" type="text" id="departmentName" onChange={handleChange} value={dto.name} />
                    </div>
                </div>
                <div className='flex gap-2 mb-3 w-1/2'>
                    <div className='flex-1'>
                        <Label htmlFor="description">Description</Label>
                        <TextArea disabled={type == FormType.INFO} placeholder="Department Description" onChange={(e: string) => setDto(prev => ({ ...prev, description: e }))} value={dto.description} />
                    </div>
                </div>
